...
public abstract class JNachos {
	...
	/**
	 * point to the current position in Swap Space
	 */
	public static int Offset = 0;
	
	/**
	 * List of pages in Main Memory
	 * every item just has two values, int[0] is process id, int[1] is virtual page number
	 */
	public static LinkedList<int[]> pageRamList;
	
	/**
	 * count page faults
	 */
	public static int numOfPageFaults = 0;
	...
	public static void initialize(String args[]) {
		...
		// open connection with SwapSpace
		mSwapSpace = mFileSystem.open("./SwapSpace.txt");
		assert (mSwapSpace != null);
		
		// initialize Page List
		pageRamList = new LinkedList<>();
