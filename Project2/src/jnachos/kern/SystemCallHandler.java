...
public class SystemCallHandler {
	...
	public static void handleSystemCall(int pWhichSysCall) {
		...
		case SC_Exit:
			...
			System.out.println("\nCurrent Process " + JNachos.getCurrentProcess().getName() + " exiting with code " + arg);
		...
		case SC_Fork:
			System.out.println("\nProcess" + JNachos.getCurrentProcess().getPid() + " Enter System Call SC_Fork");
		...
		case SC_Join:
			System.out.println("\nProcess" + JNachos.getCurrentProcess().getPid() + " Enter System Call SC_Join");
		...
		case SC_Exec:
			System.out.println("\nProcess" + JNachos.getCurrentProcess().getPid() + " Enter System Call SC_Exec");
